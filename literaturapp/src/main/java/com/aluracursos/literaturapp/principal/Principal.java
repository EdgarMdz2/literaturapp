package com.aluracursos.literaturapp.principal;

import com.aluracursos.literaturapp.model.*;
...
import com.aluracursos.literaturapp.service.ConsumoApi;
import com.aluracursos.literaturapp.service.ConvierteDatos;
...
public class Principal {
    ...
    public void menu() {
        ...
        while (opcion != 0){
            var menu = """
                           ...
                           >>>>MENÚ<<<<         
                     [1] Buscar libro por titulo y registrarlo en la base de datos
                     [2] Consultar libros registrados en base de datos
                     [3] Consultar autores registrados en base de datos
    ...
    private void buscarLibroPorTitulo(){
        System.out.println("Escribe el titulo del libro que deseas registrar:");
        ...
        if(datos.resultadoLibros().isEmpty()){
            System.out.println("El libro " + buscarTitulo + " no pudo ser encontrado.");
        }else {
